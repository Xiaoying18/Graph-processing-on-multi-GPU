...
LegionRuntime::Logger::Category log_bfs("bfs");
                    ...
                    Context ctx, HighLevelRuntime *runtime)
{
  ...
  bool check = false;
  {
    ...
    log_bfs.print("bfs settings: numPartitions(%d) start(%u) filename(%s)",
  ...
  int iter = 0;
  log_bfs.print("Start bfs computation...");
  ...
  log_bfs.print("Finish bfs computation...");
  ...
  if (check) {
    ...
    fm.wait_all_results();
    log_bfs.print("Correctness check completed...");
  }
}
